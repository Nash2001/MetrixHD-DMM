#Embedded file name: /media/build/openvuplus/build/tmp/work/all-oe-linux/vti-addon/vti-addon-2.4-r20130216.5.1.0/vti-addon/Converter/VtiInfo.py
...
class MetrixInfo(Poll, Converter, object):
    ECMINFO = 1
    ONLINETEST = 21
    TEMPINFO = 22
    FANINFO = 23
